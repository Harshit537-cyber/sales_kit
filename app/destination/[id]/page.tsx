...
export default function DestinationDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF7F2] text-[#241A10]">
      <section className="relative min-h-[620px] text-[#FAF5EE] pt-10 pb-20 px-6 md:px-12 overflow-hidden flex flex-col justify-between">
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/25 to-black/35 z-10" />
        </div>
        ...
        <div className="relative z-20 max-w-6xl mx-auto w-full">
          <div className="flex items-center justify-between mb-8">
            ...
            >
              <ArrowLeft className="w-4 h-4 text-[#C28E58]" />
              Back to Home
            </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              {images.length > 1 && (
                <div className="flex items-center gap-2 bg-black/50 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/20">
                  ...
                  <span className="text-[11px] font-mono tracking-widest text-[#FAF5EE]">
          ...
          <div className="flex items-center gap-2 text-xs text-[#EBDCC9] font-mono mb-2 drop-shadow-md">
            <MapPin className="w-4 h-4 text-[#C28E58]" />
            <span>Madhya Pradesh, India</span>
          </div>

          <h1 className="text-4xl md:text-6xl font-serif font-bold text-white mb-3 tracking-tight drop-shadow-[0_3px_8px_rgba(0,0,0,0.8)]">
            {name}
          </h1>

          {tagline && (
            <p className="text-base md:text-xl text-[#FAF5EE] max-w-3xl font-medium drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
              {tagline}
            </p>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
            {essentialTravelInfo.weatherAndSeasonality && (
              <div className="bg-[#170E08]/75 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-xl">
                <Calendar className="w-5 h-5 text-[#C28E58] mb-2" />
                <div className="text-[11px] text-[#C28E58] uppercase font-mono tracking-wider font-semibold">Seasonality</div>
                <div className="text-xs text-white/95 mt-1 leading-relaxed">
                  {essentialTravelInfo.weatherAndSeasonality}
                </div>
              </div>
            )}
            ...
            {essentialTravelInfo.nearestAirport && (
              <div className="bg-[#170E08]/75 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-xl">
                <Plane className="w-5 h-5 text-[#C28E58] mb-2" />
                <div className="text-[11px] text-[#C28E58] uppercase font-mono tracking-wider font-semibold">Airport</div>
                <div className="text-xs text-white/95 mt-1 leading-relaxed">
                  {essentialTravelInfo.nearestAirport}
                </div>
              </div>
            ...
            {essentialTravelInfo.nearestRailhead && (
              <div className="bg-[#170E08]/75 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-xl">
                <Train className="w-5 h-5 text-[#C28E58] mb-2" />
                <div className="text-[11px] text-[#C28E58] uppercase font-mono tracking-wider font-semibold">Railhead</div>
                <div className="text-xs text-white/95 mt-1 leading-relaxed">
                  {essentialTravelInfo.nearestRailhead}
                </div>
              </div>
            ...
            {essentialTravelInfo.roadConnectivity && (
              <div className="bg-[#170E08]/75 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-xl">
                <Car className="w-5 h-5 text-[#C28E58] mb-2" />
                <div className="text-[11px] text-[#C28E58] uppercase font-mono tracking-wider font-semibold">Road Access</div>
                <div className="text-xs text-white/95 mt-1 leading-relaxed">
                  {essentialTravelInfo.roadConnectivity}
                </div>
              </div>
              ...
              {images.map((_, idx) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    idx === currentSlide ? "w-8 bg-[#C28E58]" : "w-2 bg-white/60 hover:bg-white"
                  }`}
                />
              ))}
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 pt-12 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            {images.length > 0 && (
              <div className="bg-white rounded-3xl p-5 shadow-xl shadow-black/5 border border-[#EFE4D8]">
                ...
                <div className="relative w-full h-80 md:h-[400px] rounded-2xl overflow-hidden bg-[#FAF3EA] mb-4">
                  <img
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-black/5 border border-[#EFE4D8]">
              <h2 className="text-xl font-serif font-bold text-[#241A10] mb-4">
                About {name}
              </h2>
              <p className="text-sm leading-relaxed text-[#5C4D3E] whitespace-pre-line">
                {description}
              </p>
            </div>
            ...
            {highlights.length > 0 && (
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-black/5 border border-[#EFE4D8]">
                <h2 className="text-xl font-serif font-bold text-[#241A10] mb-6">
                ...
                <div className="grid grid-cols-1 gap-3.5">
                  {highlights.map((item, idx) => (
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-[#241A10] leading-snug">
                        {item}
                      </span>
                    </div>
                  ))}
            ...
            {essentialTravelInfo.canBeCombinedWith && essentialTravelInfo.canBeCombinedWith.length > 0 && (
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-black/5 border border-[#EFE4D8]">
                <div className="flex items-center gap-2 mb-4">
                  <Layers className="w-5 h-5 text-[#C28E58]" />
                  <h2 className="text-lg font-serif font-bold text-[#241A10]">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-6 shadow-xl shadow-black/5 border border-[#EFE4D8]">
              <h3 className="font-serif font-bold text-base text-[#241A10] mb-2">
                Book Safaris & Packages
              </h3>
              <p className="text-xs text-[#8A7A6C] mb-6 leading-relaxed">
        ...
        {mapImage && (
          <div className="mt-10 bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-black/5 border border-[#EFE4D8]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-2">
                  <MapIcon className="w-5 h-5 text-[#C28E58]" />
                  <h2 className="text-xl font-serif font-bold text-[#241A10]">
              ...
              <div className="flex items-center gap-2 bg-[#FAF7F2] p-1.5 rounded-2xl border border-[#EFE4D8] self-start sm:self-auto">
                <button
                ...
                <span className="text-[11px] font-mono font-semibold px-2 text-[#976634]">
            ...
            <div className="relative w-full h-[450px] md:h-[650px] overflow-auto rounded-2xl bg-[#FAF7F2] border border-[#EFE4D8] flex items-center justify-center p-4">
              <img
                src={mapImage}
                alt={`${name} Large Map`}
