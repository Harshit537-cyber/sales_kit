          ...
          >
            <span className="flex items-center gap-2.5">
              <Compass
                ...
                strokeWidth={2.25}
              />
              <span className="truncate">Destination Information</span>
            </span>
            <ChevronDown
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3.5 py-2.5 transition-colors select-none ${
                          isExpanded
                            ? "bg-[#FAF3EA]"
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className="text-xs font-semibold text-[#241A10]">
                            {cat.title}
                          </span>
                        </div>
                ...
                <div className="rounded-xl border border-[#F3EBE1] overflow-hidden bg-white">
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-xs font-semibold text-[#241A10] flex items-center gap-1.5">
                        Luxury
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
